...
public class djkTest {
	...
	public static final String FILENAME = "C:\\Users\\kyllecolumna\\Desktop\\MP.txt";
	...
	public static void main(String[] args) {
		...
		int level = 0;
	     ...
	     // DEFINE VALUES
	     int roomCount = s.nextInt(); // incorrect; resolve
	     ...
	     for (i = 0; i < pathCount; i++) {
	       ...
	       // DECLARE ARRAYS
	       start[i] = /* second int (on sCurrentLine) */;
   ...
   final Map<String, Vertex> graph; // mapping of vertex names to Vertex objects, built from a set of Edges
  ...
  public static class Vertex implements Comparable<Vertex>{
   ...
   public void Graph(Edge[] edges) {         // is this actually void
